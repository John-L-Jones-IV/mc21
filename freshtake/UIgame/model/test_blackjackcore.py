...
class TestCardMethods(unittest.TestCase):
    def test_get_val_as_int(self):
        card = Card("hearts", "A")
        self.assertEqual(card.int_value, 11)
        card = Card("spades", "A")
        self.assertEqual(card.int_value, 11)
        card = Card("clubs", "A")
        self.assertEqual(card.int_value, 11)
        ...
        card = Card("hearts", "J")
        self.assertEqual(card.int_value, 10)
        card = Card("clubs", "Q")
        self.assertEqual(card.int_value, 10)
        card = Card("hearts", "K")
        self.assertEqual(card.int_value, 10)
        ...
        self.assertEqual(card.int_value, 10)
        card = Card("spades", "6")
        self.assertEqual(card.int_value, 6)
        card = Card("clubs", "2")
        self.assertEqual(card.int_value, 2)
    ...
    def test_get_value_as_str(self):
        ...
        card = Card("hearts", "J")
        self.assertEqual(card.value, "J")
        card = Card("clubs", "Q")
        self.assertEqual(card.value, "Q")
        card = Card("hearts", "K")
        self.assertEqual(card.value, "K")
        card = Card("spades", "J")
        self.assertEqual(card.value, "J")
...
class TestPlayerMethods(unittest.TestCase):
    def test_get_best_hand_value(self):
        ...
        self.assertEqual(player.hand.best_value, 11)

        player = Player(200)
        player.add_card_to_hand(Card("hearts", "6"))
        player.add_card_to_hand(Card("clubs", "6"))
        self.assertEqual(player.hand.best_value, 12)
        ...
        self.assertEqual(player.hand.best_value, 13)

        player = Player(200)
        player.add_card_to_hand(Card("hearts", "A"))
        player.add_card_to_hand(Card("clubs", "K"))
        self.assertEqual(player.hand.best_value, 21)

    def test_get_second_best_hand_value(self):
        player = Player(200)
        player.add_card_to_hand(Card("hearts", "A"))
        player.add_card_to_hand(Card("clubs", "K"))
        self.assertEqual(player.hand.second_best_value, 11)

        player = Player(200)
        player.add_card_to_hand(Card("hearts", "A"))
        player.add_card_to_hand(Card("clubs", "7"))
        player.add_card_to_hand(Card("clubs", "7"))
        self.assertEqual(player.hand.second_best_value, 15)

        player = Player(200)
        player.add_card_to_hand(Card("hearts", "2"))
        player.add_card_to_hand(Card("clubs", "2"))
        self.assertEqual(player.hand.second_best_value, 4)
    ...
    def test_is_hand_bust(self):
        ...
        player.add_card_to_hand(Card(randomsuit, "5"))
        player.add_card_to_hand(Card(randomsuit, "8"))
        self.assertTrue(player.hand.is_bust())
        ...
        player.add_card_to_hand(Card(randomsuit, "10"))
        player.add_card_to_hand(Card(randomsuit, "A"))
        self.assertFalse(player.hand.is_bust())
